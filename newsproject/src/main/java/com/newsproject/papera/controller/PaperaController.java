package com.newsproject.papera.controller;
...
import com.newsproject.papera.service.PaperaService;
...
public class PaperaController { 
	...
	private final String MODULE = "papera"; 
	
	//@AllArgsConstructor // 생성자를 이용한 자동 DI 적용
	//@Autowired // setter를 이용한 자동 DI 적용
	@Autowired
	@Qualifier("paperaServiceImpl")
	private PaperaService service;
	...
	public String write(PaperaVO vo) {
		service.write(vo);
	...
	public String update(PaperaVO vo) {
		service.update(vo);
	...
	public String delete(PaperaVO vo) {
		service.delete(vo);
		return "redirect:list.do";
	}
