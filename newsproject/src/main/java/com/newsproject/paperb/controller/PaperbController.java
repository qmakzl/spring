package com.newsproject.paperb.controller;
...
import com.newsproject.paperb.service.PaperbService;
...
//생성해 준다.
@Controller
@RequestMapping("/paperb")
//@AllArgsConstructor // 생성자를 이용한 자동 DI 적용
public class PaperbController { 
	
	private final String MODULE = "paperb"; 
	
	//@AllArgsConstructor // 생성자를 이용한 자동 DI 적용
	//@Autowired // setter를 이용한 자동 DI 적용
	@Autowired
	@Qualifier("paperbServiceImpl")
	private PaperbService service;
	...
	public String write(PaperbVO vo) {
		service.write(vo);
	...
	public String update(PaperbVO vo) {
		service.update(vo);
	...
	public String delete(PaperbVO vo) {
		service.delete(vo);
		return "redirect:list.do";
	}
